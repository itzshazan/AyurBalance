...
android {
    namespace = "com.ayurbalance"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.ayurbalance"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    // Keep TFLite model uncompressed so it can be memory-mapped at runtime
    androidResources {
        noCompress += "tflite"
    }
...
dependencies {
    ...
    // Splash Screen API (Android 12+ compat)
    ...
    // Location Services (for Ritucharya season detection)
